...
/*for ($i=1; $i<=12; $i++) { 
    ...
    $existe = $mysqli->query( "SELECT * FROM profesor WHERE noTrabajador='$idProfe'");
    ...
    if($existe){
        ...
        $busqueda1=$mysqli->query("UPDATE martes SET siete=$GLOBALS'[12]',ocho=$GLOBALS'[22]',nueve=$GLOBALS'[32]',diez=$GLOBALS'[42]',once=$GLOBALS'[52]',doce=$GLOBALS'[62]',trece=$GLOBALS'[72]',catorce=$GLOBALS'[82]',quince=$GLOBALS'[92]',diezseis=$GLOBALS'[102]',diezsiete=$GLOBALS'[112]',diezocho=$GLOBALS'[122]', WHERE noTrabajador=$idProfe");
        $busqueda1=$mysqli->query("UPDATE miercoles SET siete=$GLOBALS'[13]',ocho=$GLOBALS'[23]',nueve=$GLOBALS'[33]',diez=$GLOBALS'[43]',once=$GLOBALS'[53]',doce=$GLOBALS'[63]',trece=$GLOBALS'[73]',catorce=$GLOBALS'[83]',quince=$GLOBALS'[93]',diezseis=$GLOBALS'[103]',diezsiete=$GLOBALS'[113]',diezocho=$GLOBALS'[123]', WHERE noTrabajador=$idProfe");
        $busqueda1=$mysqli->query("UPDATE jueves SET siete=$GLOBALS'[14]',ocho=$GLOBALS'[24]',nueve=$GLOBALS'[34]',diez=$GLOBALS'[44]',once=$GLOBALS'[54]',doce=$GLOBALS'[64]',trece=$GLOBALS'[74]',catorce=$GLOBALS'[84]',quince=$GLOBALS'[94]',diezseis=$GLOBALS'[104]',diezsiete=$GLOBALS'[114]',diezocho=$GLOBALS'[124]', WHERE noTrabajador=$idProfe");
        $busqueda1=$mysqli->query("UPDATE viernes SET siete=$GLOBALS'[15]',ocho=$GLOBALS'[25]',nueve=$GLOBALS'[35]',diez=$GLOBALS'[45]',once=$GLOBALS'[55]',doce=$GLOBALS'[65]',trece=$GLOBALS'[75]',catorce=$GLOBALS'[85]',quince=$GLOBALS'[95]',diezseis=$GLOBALS'[105]',diezsiete=$GLOBALS'[115]',diezocho=$GLOBALS'[125]', WHERE noTrabajador=$idProfe");
    }else{
